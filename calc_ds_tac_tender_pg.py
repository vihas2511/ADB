...
def runTenderPgCalc(spark, logger, database_name):
    query = f"""
...
SELECT 
  ...
  concat(
    carrier_id, '-', `tms_service_code`, 
    '-', `load_id`, '-', scotts_magical_field_of_dreams
  ) AS cassell_key, 
  to_date(`tender_event_date_a_time`) AS tender_date_time_type, 
  TO_DATE(
    current_timestamp()
  ) AS `current_date` --     , MAX(week_begin_date) OVER(ORDER BY workweekday)                                                AS max_begin_date
FROM 
  (
    SELECT 
      ...
      table_569288147_2.carrier_description AS carrier_description --, table_569288147_2.tms_service_code                                       AS tms_service_code
      , 
      ...
      CASE when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'METL' then 'W28T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'PCD6' then 'WCP6' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'PCD7' then 'WCP7' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'PIM6' then 'WAP6' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'SIM5' then 'WAS5' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'SIM6' then 'WAS6' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'SIM7' then 'WAS7' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'SLD7' then 'WFS7' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TECO' then 'W15T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TELO' then 'W17T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TL' then 'W01T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TL2R' then 'W23T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLBR' then 'W03T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLCD' then 'W18T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLCG' then 'W04T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLDD' then 'W25T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLDE' then 'W06T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLDS' then 'W19T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLEO' then 'W13T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLEV' then 'W12T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLHT' then 'W09T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLHZ' then 'W22T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLJ1' then 'W26T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLLE' then 'W16T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLLG' then 'W07T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLLH' then 'W11T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLNO' then 'W05T' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLOC' then 'TOC' when to_date(
        table_569288147_1.actual_goods_issue_date
      ) >= to_date('2018-05-28') 
      AND table_569288147_2.tms_service_code = 'TLTO' then 'W02T' ELSE table_569288147_2.tms_service_code END AS tms_service_code -- tms_service_code_new
      , 
      CASE WHEN table_569288147_2.`tender_event_type_code` = "TENDACC" THEN "Carrier Response" WHEN table_569288147_2.`tender_event_type_code` = "TENDCNCL" THEN "Carrier Response" WHEN table_569288147_2.`tender_event_type_code` = "TENDFRST" THEN "P&G Tender" WHEN table_569288147_2.`tender_event_type_code` = "TENDOTHER" THEN "P&G Tender" ELSE "Carrier Response" END AS scotts_magical_field_of_dreams 
    FROM 
      ...
      RIGHT JOIN (
        ...
        FROM 
          tac
      ) table_569288147_2 ON table_569288147_1.actual_goods_issue_date = table_569288147_2.actual_ship_date
  ) concatkey ----WHERE
  ----       scotts_magical_field_of_dreams = "P&G Tender"
  ;
DROP 
  TABLE IF EXISTS tmp_tac_tender_pg;
...
SELECT 
  ...
  table_1257076127_2.tender_date_time_type AS tender_date_time_type --, table_1257076127_2.max_begin_date                                         AS max_begin_date
  , 
...
FROM 
  (
    SELECT 
      cassell_key, 
      MIN(
        table_491629510.tender_event_date_a_time
      ) AS tender_event_date_a_time 
    FROM 
  ...
  LEFT JOIN tmp_tac_tender_pg_1 AS table_1257076127_2 ON table_1257076127_1.cassell_key = table_1257076127_2.cassell_key 
  AND table_1257076127_1.tender_event_date_a_time = table_1257076127_2.tender_event_date_a_time CROSS 
  JOIN (
    SELECT 
      MAX(week_begin_date) AS max_begin_date 
    FROM 
      tmp_tac_tender_pg_1
  ) AS dt 
WHERE 
  table_1257076127_2.scotts_magical_field_of_dreams = "P&G Tender";
...
SELECT 
  ...
  dt.max_begin_date AS max_begin_date --        , (SELECT MAX(week_begin_date) FROM tmp_tac_tender_pg_1)                   AS max_begin_date
...
FROM 
  (
    SELECT 
      cassell_key, 
      MAX(
        table_1306472724.tender_event_date_a_time
      ) AS tender_event_date_a_time 
    FROM 
  ...
  LEFT JOIN tmp_tac_tender_pg_1 AS table_102901341_2 ON table_102901341_1.cassell_key = table_102901341_2.cassell_key 
  AND table_102901341_1.tender_event_date_a_time = table_102901341_2.tender_event_date_a_time CROSS 
  JOIN (
    SELECT 
      MAX(week_begin_date) AS max_begin_date 
    FROM 
...
DROP 
  TABLE IF EXISTS ds_tac_tender_pg_tenders_only;
...
SELECT 
  ...
  SUM(
    actual_carrier_total_transportation_cost_usd
  ) AS actual_carrier_total_transportation_cost_usd, 
...
FROM 
  (
    SELECT 
      ...
      table_1257076127_2.tms_service_code AS tms_service_code, 
      CASE WHEN TO_DATE(
        table_1257076127_2.actual_ship_date
      ) < '2018-09-10' 
      AND table_1257076127_2.freight_type = 'INTERPLANT' THEN CONCAT(
        table_1257076127_2.origin_sf, '-', 
        table_1257076127_2.destination_sf
      ) WHEN TO_DATE(
        table_1257076127_2.actual_ship_date
      ) < '2018-09-10' 
      AND table_1257076127_2.freight_type = 'CUSTOMER' THEN CONCAT(
        table_1257076127_2.origin_sf, 
        '-', 
        CASE WHEN table_1257076127_2.country_to = "CA" THEN SUBSTR(
          table_1257076127_2.postal_code_raw_tms, 
          1, 6
        ) WHEN table_1257076127_2.country_to = "US" THEN SUBSTR(
          table_1257076127_2.postal_code_raw_tms, 
          1, 5
        ) END
      ) ELSE CONCAT(
      ...
      CONCAT(
        table_1257076127_2.week_number, 
        '/', table_1257076127_2.calendar_year
      ) AS calendar_year_week_tac, 
      table_1257076127_2.actual_carrier_total_transportation_cost_usd AS actual_carrier_total_transportation_cost_usd, 
      table_1257076127_2.linehaul AS linehaul, 
      table_1257076127_2.incremental_fa AS incremental_fa, 
      table_1257076127_2.cnc_carrier_mix AS cnc_carrier_mix, 
    ...
    FROM 
      ...
      LEFT JOIN tmp_tac_tender_pg_1 AS table_1257076127_2 ON table_1257076127_1.cassell_key = table_1257076127_2.cassell_key 
      AND table_1257076127_1.tender_event_date_a_time = table_1257076127_2.tender_event_date_a_time --                   WHERE
...
FROM 
  tmp_tac_tender_pg;
DROP 
  TABLE IF EXISTS tac_tender_pg_summary_1;
CREATE TEMPORARY VIEW tac_tender_pg_summary_1 AS 
SELECT 
  *, 
  case when to_date(actual_ship_date) < '2018-09-10' 
  AND freight_type = 'INTERPLANT' then concat(origin_sf, '-', destination_sf) when to_date(actual_ship_date) < '2018-09-10' 
  AND freight_type = 'CUSTOMER' then concat(origin_sf, '-', destination_zip) else concat(origin_sf, '-', destination_sf) end as lane, 
  case when to_date(actual_ship_date) < '2018-09-10' 
  AND freight_type = 'INTERPLANT' then concat(origin_sf, '-', destination_sf) when to_date(actual_ship_date) < '2018-09-10' 
  AND freight_type = 'CUSTOMER' then concat(origin_sf, '-', destination_zip) else concat(
    origin_location_id, '-', destination_location_id
  ) end as lane_new, 
  case when freight_type = 'INTERPLANT' then concat(origin_sf, '-', destination_sf) when freight_type = 'CUSTOMER' then concat(origin_sf, '-', destination_zip) end as historical_lane, 
  concat(
    origin_sf, '-', destination_location_id
  ) as customer_specific_lane, 
  concat(week_number, '/', calendar_year) as calendar_year_week_tac, 
  case when to_date(actual_ship_date) >= '2018-09-10' then destination_sf else postal_code_final_stop end as destination 
FROM 
  (
    SELECT 
      *, 
      case when tender_event_type_code = "TENDACC" THEN 1 else 0 end as accept_count, 
      case when tender_event_type_code IN ("TENDFRST", "TENDOTHER") THEN 1 else 0 end as total_count, 
      to_date(actual_ship_date) as actual_ship_date_format, 
      case when country_to = "CA" then substr(postal_code_raw_tms, 1, 6) when country_to = "US" then substr(postal_code_raw_tms, 1, 5) end as destination_zip 
    FROM 
      (
        SELECT 
          T.cassell_key, 
          ...
          T.state_province, 
          SUM (
            CASE WHEN day_of_the_week = 'Monday' THEN accept_count END
          ) Monday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Monday' THEN total_count END
          ) Monday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Thursday' THEN accept_count END
          ) Thursday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Thursday' THEN total_count END
          ) Thursday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Friday' THEN accept_count END
          ) Friday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Friday' THEN total_count END
          ) Friday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Sunday' THEN accept_count END
          ) Sunday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Sunday' THEN total_count END
          ) Sunday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Wednesday' THEN accept_count END
          ) Wednesday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Wednesday' THEN total_count END
          ) Wednesday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Tuesday' THEN accept_count END
          ) Tuesday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Tuesday' THEN total_count END
          ) Tuesday_total_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Saturday' THEN accept_count END
          ) Saturday_accept_count, 
          SUM (
            CASE WHEN day_of_the_week = 'Saturday' THEN total_count END
        ...
        FROM 
          (
            SELECT 
              ...
              case when table_324461333_1.max_begin_date = table_324461333_1.`current_date` then '1' when table_324461333_1.week_begin_date < table_324461333_1.max_begin_date 
              OR table_324461333_1.week_begin_date IS NULL then '1' else '0' end as filter_partial_weeks, 
              case when table_324461333_1.tender_event_type_code = "TENDACC" THEN 1 else 0 end as accept_count, 
              case when table_324461333_1.tender_event_type_code IN ("TENDFRST", "TENDOTHER") THEN 1 else 0 end as total_count 
            FROM 
              tmp_tac_tender_pg -- ds_tac_tender_pg_mxdt
              AS table_324461333_1 
              LEFT JOIN shipping_location AS table_324461333_2 ON table_324461333_1.destination_location_id = table_324461333_2.`location id`
          ) T -- As part of Req-id RITM2746877, below where clause is disabled to publish data for all days of the week.
...
SELECT 
  ...
  cast(
    table_717798636_2.customer_level_12_description as decimal(38, 16)
  ) AS customer_level_12_description, 
  cast(
    table_717798636_2.customer_specific_lane as decimal(38, 16)
  ) AS customer_specific_lane 
FROM 
  ...
  JOIN (
    SELECT 
      ...
      rejects_below_award, 
      weekly_tac, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_id_description end as customer_id_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer end as customer, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_3_description end as customer_3_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_5_description end as customer_level_5_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_6_description end as customer_level_6_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_12_description end as customer_level_12_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_specific_lane end as customer_specific_lane 
    FROM 
      (
        SELECT 
          *, 
          case when 0 > (expected_volume - accept_count) then 0 else expected_volume - accept_count end as rejects_below_award, 
          ...
          (
            SELECT 
              *, 
              ...
              case when average_awarded_weekly_volume > total_count then total_count when average_awarded_weekly_volume < total_count then average_awarded_weekly_volume else total_count end as expected_volume 
            FROM 
              (
                SELECT 
                  ...
                  (
                    table_696478142_2.total_count - table_696478142_2.accept_count
                  ) AS reject_count 
                FROM 
                  (
                    SELECT 
                      ...
                      calendar_year_week_tac, 
                      count(
                        DISTINCT table_1742270680.customer_level_12_description
                      ) AS distinct_count_customers_customer_level_12_description_ 
                    FROM 
                  ...
                  RIGHT JOIN (
                    SELECT 
                      ...
                      MIN(
                        table_1644172437.tender_event_date_a_time
                      ) AS tender_event_date_a_time, 
                      MIN(
                        table_1644172437.actual_ship_date
                      ) AS actual_ship_date, 
                      MIN(
                        table_1644172437.tac_day_of_year
                      ) AS tac_day_of_year, 
                      MIN(table_1644172437.workweekday) AS workweekday, 
                      MIN(
                        table_1644172437.week_begin_date
                      ) AS week_begin_date, 
                      ...
                      MIN(
                        table_1644172437.origin_location_id
                      ) AS origin_location_id, 
                      MIN(table_1644172437.origin_zone) AS origin_zone, 
                      MIN(
                        table_1644172437.destination_sf
                      ) AS destination_sf, 
                      MIN(
                        table_1644172437.destination_zone
                      ) AS destination_zone, 
                      MIN(
                        table_1644172437.destination_location_id
                      ) AS destination_location_id, 
                      MIN(table_1644172437.customer_id) AS customer_id, 
                      MIN(
                        table_1644172437.customer_id_description
                      ) AS customer_id_description, 
                      MIN(
                        table_1644172437.carrier_description
                      ) AS carrier_description, 
                      MIN(table_1644172437.mode) AS mode, 
                      MIN(
                        table_1644172437.tender_event_type_code
                      ) AS tender_event_type_code, 
                      MIN(
                        table_1644172437.tender_reason_code
                      ) AS tender_reason_code, 
                      MIN(
                        table_1644172437.tender_event_date
                      ) AS tender_event_date, 
                      MIN(
                        table_1644172437.tender_event_time
                      ) AS tender_event_time, 
                      MIN(
                        table_1644172437.transportation_planning_point
                      ) AS transportation_planning_point, 
                      MIN(
                        table_1644172437.departure_country_code
                      ) AS departure_country_code, 
                      MIN(
                        table_1644172437.sap_original_shipdate
                      ) AS sap_original_shipdate, 
                      MIN(
                        table_1644172437.original_tendered_ship_date
                      ) AS original_tendered_ship_date, 
                      MIN(
                        table_1644172437.day_of_the_week_of_original_tendered_shipdate
                      ) AS day_of_the_week_of_original_tendered_shipdate, 
                      MIN(
                        table_1644172437.actual_ship_time
                      ) AS actual_ship_time, 
                      MIN(
                        table_1644172437.actual_ship_date_and_time
                      ) AS actual_ship_date_and_time, 
                      MIN(table_1644172437.sold_to_n) AS sold_to_n, 
                      MIN(
                        table_1644172437.no_of_days_in_week
                      ) AS no_of_days_in_week, 
                      MIN(
                        table_1644172437.no_of_days_in_month
                      ) AS no_of_days_in_month, 
                      MIN(table_1644172437.scac) AS scac, 
                      MIN(
                        table_1644172437.carrier_mode_description
                      ) AS carrier_mode_description, 
                      MIN(table_1644172437.tariff_id) AS tariff_id, 
                      MIN(table_1644172437.schedule_id) AS schedule_id, 
                      MIN(
                        table_1644172437.tender_event_type_description
                      ) AS tender_event_type_description, 
                      MIN(
                        table_1644172437.tender_acceptance_key
                      ) AS tender_acceptance_key, 
                      MIN(
                        table_1644172437.tender_reason_code_description
                      ) AS tender_reason_code_description, 
                      MIN(
                        table_1644172437.scheduled_date
                      ) AS scheduled_date, 
                      MIN(
                        table_1644172437.scheduled_time
                      ) AS scheduled_time, 
                      MIN(
                        table_1644172437.average_awarded_weekly_volume
                      ) AS average_awarded_weekly_volume, 
                      MIN(table_1644172437.daily_award) AS daily_award, 
                      MIN(
                        table_1644172437.day_of_the_week
                      ) AS day_of_the_week, 
                      MIN(
                        table_1644172437.allocation_type
                      ) AS allocation_type, 
                      MIN(
                        table_1644172437.sun_max__loads_
                      ) AS sun_max__loads_, 
                      MIN(
                        table_1644172437.mon_max__loads_
                      ) AS mon_max__loads_, 
                      MIN(
                        table_1644172437.tue_max__loads_
                      ) AS tue_max__loads_, 
                      MIN(
                        table_1644172437.wed_max__loads_
                      ) AS wed_max__loads_, 
                      MIN(
                        table_1644172437.thu_max__loads_
                      ) AS thu_max__loads_, 
                      MIN(
                        table_1644172437.fri_max__loads_
                      ) AS fri_max__loads_, 
                      MIN(
                        table_1644172437.sat_max__loads_
                      ) AS sat_max__loads_, 
                      MIN(
                        table_1644172437.gbu_per_shipping_site
                      ) AS gbu_per_shipping_site, 
                      MIN(
                        table_1644172437.shipping_conditions
                      ) AS shipping_conditions, 
                      MIN(
                        table_1644172437.postal_code_raw_tms
                      ) AS postal_code_raw_tms, 
                      MIN(
                        table_1644172437.postal_code_final_stop
                      ) AS postal_code_final_stop, 
                      MIN(table_1644172437.country_from) AS country_from, 
                      MIN(table_1644172437.country_to) AS country_to, 
                      MIN(
                        table_1644172437.freight_auction_flag
                      ) AS freight_auction_flag, 
                      MIN(table_1644172437.true_fa_flag) AS true_fa_flag, 
                      MIN(table_1644172437.freight_type) AS freight_type, 
                      MIN(
                        table_1644172437.operational_freight_type
                      ) AS operational_freight_type, 
                      MIN(
                        table_1644172437.pre_tms_upgrade_flag
                      ) AS pre_tms_upgrade_flag, 
                      MIN(
                        table_1644172437.data_structure_version
                      ) AS data_structure_version, 
                      MIN(
                        table_1644172437.primary_carrier_flag
                      ) AS primary_carrier_flag, 
                      MIN(
                        table_1644172437.tendered_back_to_primary_carrier_with_no_fa_adjustment
                      ) AS tendered_back_to_primary_carrier_with_no_fa_adjustment, 
                      MIN(
                        table_1644172437.tendered_back_to_primary_carrier_with__fa_adjustment
                      ) AS tendered_back_to_primary_carrier_with__fa_adjustment, 
                      MIN(
                        table_1644172437.tender_accepted_loads_with_no_fa
                      ) AS tender_accepted_loads_with_no_fa, 
                      MIN(
                        table_1644172437.tender_accepted_loads_with_fa
                      ) AS tender_accepted_loads_with_fa, 
                      MIN(
                        table_1644172437.tender_rejected_loads
                      ) AS tender_rejected_loads, 
                      MIN(
                        table_1644172437.previous_tender_date_a_time
                      ) AS previous_tender_date_a_time, 
                      MIN(
                        table_1644172437.time_between_tender_events
                      ) AS time_between_tender_events, 
                      MIN(
                        table_1644172437.canceled_due_to_no_response
                      ) AS canceled_due_to_no_response, 
                      MIN(table_1644172437.customer) AS customer, 
                      MIN(
                        table_1644172437.customer_level_1_id
                      ) AS customer_level_1_id, 
                      MIN(
                        table_1644172437.customer_level_1_description
                      ) AS customer_level_1_description, 
                      MIN(
                        table_1644172437.customer_level_2_id
                      ) AS customer_level_2_id, 
                      MIN(
                        table_1644172437.customer_level_2_description
                      ) AS customer_level_2_description, 
                      MIN(
                        table_1644172437.customer_level_3_id
                      ) AS customer_level_3_id, 
                      MIN(
                        table_1644172437.customer_level_3_description
                      ) AS customer_level_3_description, 
                      MIN(
                        table_1644172437.customer_level_4_id
                      ) AS customer_level_4_id, 
                      MIN(
                        table_1644172437.customer_level_4_description
                      ) AS customer_level_4_description, 
                      MIN(
                        table_1644172437.customer_level_5_id
                      ) AS customer_level_5_id, 
                      MIN(
                        table_1644172437.customer_level_5_description
                      ) AS customer_level_5_description, 
                      MIN(
                        table_1644172437.customer_level_6_id
                      ) AS customer_level_6_id, 
                      MIN(
                        table_1644172437.customer_level_6_description
                      ) AS customer_level_6_description, 
                      MIN(
                        table_1644172437.customer_level_7_id
                      ) AS customer_level_7_id, 
                      MIN(
                        table_1644172437.customer_level_7_description
                      ) AS customer_level_7_description, 
                      MIN(
                        table_1644172437.customer_level_8_id
                      ) AS customer_level_8_id, 
                      MIN(
                        table_1644172437.customer_level_8_description
                      ) AS customer_level_8_description, 
                      MIN(
                        table_1644172437.customer_level_9_id
                      ) AS customer_level_9_id, 
                      MIN(
                        table_1644172437.customer_level_9_description
                      ) AS customer_level_9_description, 
                      MIN(
                        table_1644172437.customer_level_10_id
                      ) AS customer_level_10_id, 
                      MIN(
                        table_1644172437.customer_level_10_description
                      ) AS customer_level_10_description, 
                      MIN(
                        table_1644172437.customer_level_11_id
                      ) AS customer_level_11_id, 
                      MIN(
                        table_1644172437.customer_level_11_description
                      ) AS customer_level_11_description, 
                      MIN(
                        table_1644172437.customer_level_12_id
                      ) AS customer_level_12_id, 
                      MIN(
                        table_1644172437.customer_level_12_description
                      ) AS customer_level_12_description, 
                      MIN(
                        table_1644172437.actual_carrier_id
                      ) AS actual_carrier_id, 
                      MIN(
                        table_1644172437.actual_carrier_description
                      ) AS actual_carrier_description, 
                      MIN(
                        table_1644172437.actual_carrier_total_transportation_cost_usd
                      ) AS actual_carrier_total_transportation_cost_usd, 
                      MIN(table_1644172437.linehaul) AS linehaul, 
                      MIN(
                        table_1644172437.incremental_fa
                      ) AS incremental_fa, 
                      MIN(
                        table_1644172437.cnc_carrier_mix
                      ) AS cnc_carrier_mix, 
                      ...
                      MIN(
                        table_1644172437.skin_a_personal_care
                      ) AS skin_a_personal_care, 
                      MIN(table_1644172437.other) AS other, 
                      MIN(
                        table_1644172437.tfts_load_tmstp
                      ) AS tfts_load_tmstp, 
                      MIN(
                        table_1644172437.load_from_file
                      ) AS load_from_file, 
                      MIN(table_1644172437.bd_mod_tmstp) AS bd_mod_tmstp, 
                      MIN(
                        table_1644172437.historical_data_structure_flag
                      ) AS historical_data_structure_flag, 
                      MIN(
                        table_1644172437.scotts_magical_field_of_dreams
                      ) AS scotts_magical_field_of_dreams, 
                      MIN(
                        table_1644172437.tender_date_time_type
                      ) AS tender_date_time_type, 
                      MIN(
                        table_1644172437.state_province
                      ) AS state_province, 
                      SUM(
                        table_1644172437.monday_accept_count
                      ) AS monday_accept_count, 
                      SUM(
                        table_1644172437.monday_total_count
                      ) AS monday_total_count, 
                      SUM(
                        table_1644172437.thursday_accept_count
                      ) AS thursday_accept_count, 
                      SUM(
                        table_1644172437.thursday_total_count
                      ) AS thursday_total_count, 
                      SUM(
                        table_1644172437.friday_accept_count
                      ) AS friday_accept_count, 
                      SUM(
                        table_1644172437.friday_total_count
                      ) AS friday_total_count, 
                      SUM(
                        table_1644172437.sunday_accept_count
                      ) AS sunday_accept_count, 
                      SUM(
                        table_1644172437.sunday_total_count
                      ) AS sunday_total_count, 
                      SUM(
                        table_1644172437.wednesday_accept_count
                      ) AS wednesday_accept_count, 
                      SUM(
                        table_1644172437.wednesday_total_count
                      ) AS wednesday_total_count, 
                      SUM(
                        table_1644172437.tuesday_accept_count
                      ) AS tuesday_accept_count, 
                      SUM(
                        table_1644172437.tuesday_total_count
                      ) AS tuesday_total_count, 
                      SUM(
                        table_1644172437.saturday_accept_count
                      ) AS saturday_accept_count, 
                      SUM(
                        table_1644172437.saturday_total_count
                      ) AS saturday_total_count, 
                      SUM(table_1644172437.accept_count) AS accept_count, 
                      SUM(table_1644172437.total_count) AS total_count, 
                      MIN(
                        table_1644172437.actual_ship_date_format
                      ) AS actual_ship_date_format, 
                      MIN(
                        table_1644172437.destination_zip
                      ) AS destination_zip, 
                      MIN(
                        table_1644172437.historical_lane
                      ) AS historical_lane, 
                      MIN(
                        table_1644172437.customer_specific_lane
                      ) AS customer_specific_lane, 
                    ...
                    GROUP BY 
                      ...
                      lane, 
                      calendar_year_week_tac
                  ) table_696478142_2 ON table_696478142_1.carrier_id = table_696478142_2.carrier_id 
      ...
      ) table_1443454242 --                     WHERE
      --                            average_awarded_weekly_volume >= 0.02
      ) table_717798636_2 ON table_717798636_1.carrier_id = table_717798636_2.carrier_id 
...
FROM 
  ...
  JOIN (
    SELECT 
      ...
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer end as customer, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_3_description end as customer_3_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_4_description end as customer_level_4_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_5_description end as customer_level_5_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_6_description end as customer_level_6_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_level_12_description end as customer_level_12_description, 
      case when distinct_count_customers_customer_level_12_description_ > 1 then '*' else customer_specific_lane end as customer_specific_lane 
                ...
                FROM 
                  ...
                  RIGHT JOIN (
                    SELECT 
                      ...
                      MIN(
                        table_1644172437.scheduled_time
                      ) AS scheduled_time --, MIN(table_1644172437.average_awarded_weekly_volume)                          AS average_awarded_weekly_volume
                      , 
                      MIN(table_1644172437.daily_award) AS daily_award, 
                      MIN(
                        table_1644172437.day_of_the_week
                      ...
                      MIN(table_1644172437.destination) AS destination, 
                      MIN(
                        temp_tab.average_awarded_weekly_volume_new
                      ) AS average_awarded_weekly_volume 
                    FROM 
                      tac_tender_pg_summary_1 AS table_1644172437 
                      join (
                        SELECT 
                          ...
                          calendar_year_week_tac, 
                          MIN(
                            tab1.average_awarded_weekly_volume
                          ) AS average_awarded_weekly_volume_new 
                        FROM 
                          tac_tender_pg_summary_1 AS tab1 
                        where 
                          tab1.tender_reason_code like 'TNRD' 
                        GROUP BY 
                          carrier_id, 
                          tms_service_code, 
                          lane, 
                          lane_new, 
                          calendar_year_week_tac
                      ) temp_tab ON temp_tab.carrier_id = table_1644172437.carrier_id 
